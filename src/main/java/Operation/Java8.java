...
public class Java8 {
    public static void main(String[] args) {
        ...
        List<String> words =
                new ArrayList(Arrays.asList("Aman", "Ajay", "Vivek", "Hari", "Mohan", "Vijay", "Ashish", "Mohit", "Zeeshan", "Ravi"));
        ...
        List<String> list = words.stream().filter(t->t.startsWith("A")).collect(Collectors.toList());
